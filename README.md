...
**Synchro automatique après modification** : toute modification d'un snippet **partagé** (ajout, édition, changement de dossier, suppression) envoie **immédiatement** vers Google Sheets, sans délai ni confirmation. Seuls les snippets marqués **"Privé"** en sont exclus — tout le reste est synchronisé.
