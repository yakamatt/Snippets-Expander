...
- **Intégration Aviso** : sur `aviso2.bureauveritas.com`, une icône apparaît automatiquement à côté de "Dispositions réalisées" dès que le code du "Référentiel" de la ligne (ex: "GN 4") correspond au déclencheur d'un snippet. Cliquer dessus **ajoute** le contenu du snippet à la suite du texte déjà saisi, sans jamais l'écraser. Désactivable dans Paramètres avancés > Intégration Aviso. Sans effet sur les autres sites.
